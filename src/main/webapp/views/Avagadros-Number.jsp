		...
		<div class="row">
				...
				<div class="card px-4 py-5" style="width: 650px;">
					<div class="card-block">
						<form action="/Chemistry-Calculator/Avagadro's-Number-Result">
							<div class="mb-3">
								<label for="givenMass" class="form-label">Number of
									Moles Substance</label> <input type="text" class="form-control"
									id="moles" aria-describedby="emailHelp" name="moles"
							...
							<div class="mb-3">
								<label for="molarMass" class="form-label">Result</label> <input
									...
									id="result" name="result" value='${result}'
									style="width: 600px">
							</div>
			...
			<div class="col-lg-2" style="padding-left: 340px">
				<div class="card bg-success text-white" style="width: 520px">
					<p class="card-body h5" style="padding-bottom: 17px">The number
						...
						symbol N<sub>A</sub>. Later scientists demonstrated experimentally that the
						value of Avogadro's number is 6.022 x 10<sup>23</sup>. A mole of any
						substance stands for 6.022 x 10<sup>23</sup> molecules. Just as a dozen has
						12 items, a century has 100 or a gross has 144, a mole means 6.022
						x 10<sup>23</sup>. For example, a mole of water, that is, 18g of water
						contains 6.022 x 10<sup>23</sup> molecules of water.</p>
				</div>
			</div>
		</div>
	</div>
